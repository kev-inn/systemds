...
subprocess.run('java -cp "lib/*;SystemDS.jar" org.tugraz.sysds.pythonapi.pythonDMLScript -s "print("""HelloWorld""")" ', shell=True, cwd = "C:\\Richard\\002_SystemDS\\pythonwrapper2\\systemds\\target")
